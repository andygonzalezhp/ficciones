...
in the name of trying to provide an answer between two idealist truths. the first step in doubting is to determine what it is that you want to contradict
in the first place. this can be a material fact, such as that of physical properities that inhabit our lives, or it can be a stream of consciouss.
<br /> 
...
can any truth exist if you doubt everything in existence? what if nothing can be seen as "veritas" (truth). the same conclusion must be reached though.
